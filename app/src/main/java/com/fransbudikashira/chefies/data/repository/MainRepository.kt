        ...
        try {
            ...
            if (response.isSuccessful) {
                if (response.body() != null) {
                    ...
                    Log.d("UserRepository", "Get Recipes Response: ${response.body()}")
                } else {
                ...
                Log.e("UserRepository", "Get Recipes Error: ${errorResponse.detail}")
                emit(Result.Error(errorResponse.detail))
            }
        } catch (e: Exception) {
            Log.e("UserRepository", "Get Recipes Exception: ${e.message}")
